                ...
                switch(menu){
                    case 1://Ingresar para tomar datos de las personas quienes se van a vacunar
                     ...
                     if (contador_M>contador_P && contador_M>contador_S && contador_M>contador_V ){//Si Moderna es mayor
                      vacuna_mas= "La vacuna Moderna es la vacuna mas aplicada el dia de hoy. Con "+contador_M+" dosis aplicadas";
                     }
                        else if(contador_P>contador_S && contador_P>contador_V){
                            vacuna_mas= "La vacuna Pfizer es la vacuna mas aplicada el dia de hoy. Con "+contador_P+" dosis aplicadas";  
                        }
                                    else if(contador_S>contador_V){
                                    vacuna_mas= "La vacuna Sinovac es la vacuna mas aplicada el dia de hoy. Con "+contador_S+" dosis aplicadas";  
                                    }
                                        else if (contador_V>contador_S){
                                        vacuna_mas= "La vacuna Vacine es la vacuna mas aplicada el dia de hoy. Con "+contador_V+" dosis aplicadas";  
                                        } 
                                        else{
                                        System.out.println("Hay varias dosis que fueron las mas aplicadas ");}
